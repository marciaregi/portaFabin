...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { email: @register.email, image: @register.image, name: @register.name, office: @register.office, phone: @register.phone, sector: @register.sector }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { email: @register.email, image: @register.image, name: @register.name, office: @register.office, phone: @register.phone, sector: @register.sector }
    assert_redirected_to register_path(assigns(:register))
  end
